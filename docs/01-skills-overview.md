...
> "No-one knows exactly what they want." — David Thomas & Andrew Hunt, _The Pragmatic Programmer_
...
> "With a ubiquitous language, conversations among developers and expressions of the code are all derived from the same domain model." — Eric Evans, _Domain-Driven Design_
...
> "Always take small, deliberate steps. The rate of feedback is your speed limit." — David Thomas & Andrew Hunt, _The Pragmatic Programmer_
...
> "Invest in the design of the system _every day_." — Kent Beck, _Extreme Programming Explained_
