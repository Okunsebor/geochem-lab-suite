...
const SEED_ACTIVITY: PrepActivityEntry[] = [
  { id: "s1", time: "10:42", technician: "E. Okafor",    sampleId: "GCS-24012", stage: "Pulverizing", action: "Completed", equipment: "Pulverizer A-2", duration: 12 },
  { id: "s2", time: "10:18", technician: "K. Nakamura",  sampleId: "GCS-24008", stage: "Crushing",    action: "Completed", equipment: "JC-400",        duration: 18 },
  { id: "s3", time: "09:55", technician: "S. Patel",     sampleId: "GCS-24005", stage: "Drying",      action: "Started",   equipment: "Oven A" },
  { id: "s4", time: "09:34", technician: "M. Rivera",    sampleId: "GCS-24001", stage: "Splitting",   action: "Completed", equipment: "Riffle Splitter", duration: 6 },
  { id: "s5", time: "08:51", technician: "J. Chen",      sampleId: "GCS-24003", stage: "Crushing",    action: "Started",   equipment: "JC-401" },
  { id: "s6", time: "08:20", technician: "A. Volkov",    sampleId: "GCS-24000", stage: "Drying",      action: "Enrolled" },
];
            ...
            {rows.map((r) => {
              ...
              return (
                ...
                >
                  ...
                  <td>
                    <span className="font-mono text-xs font-semibold text-primary">{r.sampleId}</span>
                  </td>
                  <td>
                    <span
