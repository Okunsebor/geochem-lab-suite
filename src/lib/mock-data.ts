...
export const activity = [
  ...
  {
    who: "S. Patel",
    what: "registered batch of 24 samples",
    target: "Batch B-118",
    when: "1 hr ago",
  },
...
export const notifications = [
  ...
  {
    id: 2,
    title: "QA/QC anomaly on GCS-24004 — Au duplicate spread 18%",
    time: "32m",
    kind: "alert",
  },
