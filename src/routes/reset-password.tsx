...
function ResetPassword() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center p-6 sm:p-10 bg-background">
      {isExpired ? (
        <div className="w-full max-w-sm bg-card p-6 sm:p-8 rounded-xl border border-border shadow-lg flex flex-col items-center text-center">
          ...
          <p className="text-sm text-muted-foreground mb-6">
            This link has expired or is no longer valid. Please contact your administrator to send a
            new invitation.
          </p>
          <Link
            to="/login"
